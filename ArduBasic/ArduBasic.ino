...
//static const unsigned char vermsg[]           PROGMEM = "ArduBasic" kVersion; 
static const unsigned char initmsg[]          PROGMEM = "ArduBasic " kVersion;
static const unsigned char memorymsg[]        PROGMEM = " bytes of Memory(Ram) free.";
#ifdef ARDUINO
#ifdef ENABLE_EEPROM
